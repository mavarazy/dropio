  ...
  return (
    <button
      className={classNames(
        ...
        "flex font-mono text-[9px] px-2 py-2 rounded-full shadow-lg uppercase cursor-pointer hover:bg-indigo-50 hover:text-indigo-600 hover:translate-y-1 transition duration-50 ease-in-out"
      )}
      onClick={handleClick}
    >
      {icon && (
